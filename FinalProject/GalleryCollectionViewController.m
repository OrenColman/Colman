...
- (void)viewDidLoad {
    ...
    images = [[Model instance] getImages];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    GalleryItemCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    
    // Configure the cell
    UIImage * myImage = [UIImage imageNamed: @"loading.gif"];
    [cell.imageView setImage:myImage];
    
    PFFile* eventImage = [images objectAtIndex:indexPath.row];
